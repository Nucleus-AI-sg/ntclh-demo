        ...
        {!isProcessed && (
          <div className="col-span-12 mt-4 pt-8 border-t border-slate-100">
            <div className="flex items-center justify-end space-x-4">
              <button onClick={onReject} className="px-4 py-2.5 text-sm font-bold text-red-600 border-2 border-red-600 rounded hover:bg-red-50 transition-colors">
                Reject
              </button>
              <button onClick={onRequestInfo} className="px-4 py-2.5 text-sm font-bold text-slate-500 bg-slate-100 rounded hover:bg-slate-200 transition-colors">
                Request More Info
              </button>
              <button onClick={onOverride} className="px-4 py-2.5 text-sm font-bold text-blue-600 border-2 border-blue-600 rounded hover:bg-blue-50 transition-colors">
