...
export function EmployerList({ employers, vacancies }: EmployerListProps) {
  ...
  const activeCandidates = vacancies.reduce((sum, v) => sum + v.candidatesSubmitted, 0)
  ...
  return (
    <div className="space-y-6">
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
        ...
        <StatCard label="Active Candidates" value={activeCandidates} icon={Users} iconColour="amber" />
      </div>
