...
const programmeColours: Record<string, { badge: string; badgeText: string; bar: string; placed: string }> = {
  ict: { badge: 'bg-blue-50 text-blue-600', badgeText: 'text-blue-600', bar: 'bg-blue-500', placed: 'text-blue-600' },
  ba: { badge: 'bg-teal-50 text-teal-600', badgeText: 'text-teal-600', bar: 'bg-teal-500', placed: 'text-teal-600' },
  dm: { badge: 'bg-indigo-50 text-indigo-600', badgeText: 'text-indigo-600', bar: 'bg-indigo-500', placed: 'text-indigo-600' },
}
        ...
        return (
          ...
          >
            <div className="flex justify-between items-start mb-4">
              <div>
                <h3 className="font-bold text-slate-900">{prog.shortName}</h3>
                <p className="text-[10px] text-slate-500 font-medium uppercase tracking-wider">
                  In-Progress Cohort
                </p>
              </div>
              <div className={cn('font-bold px-2 py-1 rounded text-xs', colours.badge)}>
